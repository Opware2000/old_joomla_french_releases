<?php
/**
* @version $Id: content_blog_section.menu.html.php 10002 2008-02-08 10:56:57Z willebil $
* @package Joomla
* @subpackage Menus
...
class content_blog_section_html {
	...
	function edit( &$menu, &$lists, &$params, $option ) {
		...
		<tr>
			<th>
			<?php echo $menu->id ? 'Editer' : 'Ajouter';?> :: Blog - Section de contenu
			</th>
		</tr>
		</table>
			...
			<td width="60%">
				...
				<tr>
					...
					<?php echo $lists['sectionid']; ?>
			 		...
			 		<td valign="top">
			 		<?php
			 		echo mosToolTip( 'Vous pouvez sélectionner plusieurs sections' )
			 		?>
					</td>
				</tr>
				<tr>
